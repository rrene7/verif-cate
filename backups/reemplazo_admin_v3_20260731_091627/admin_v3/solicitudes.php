...
<section class="v3-card">
    <form method="get" class="v3-filters">
        ...
        <div class="v3-filter-actions">
            ...
            <a class="v3-button secondary" href="admin_v3.php?page=solicitudes">Limpiar</a>
        </div>
    </form>
        ...
        <table class="v3-table">
            ...
            <?php foreach ($rows as $row): ?>
                ...
                <tr>
                    ...
                    <td><a class="v3-button secondary" href="admin_v3.php?page=expediente&id=<?= (int) $row['id'] ?>">Abrir</a></td>
                </tr>
            <?php endforeach; ?>
