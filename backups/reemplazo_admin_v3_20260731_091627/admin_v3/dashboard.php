    ...
    <article class="v3-card">
        ...
        <div class="v3-bars">
            <?php foreach ($statusRows as $row): ?>
                ...
                <a href="admin_v3.php?page=solicitudes&status=<?= e($row['status']) ?>">
...
<section class="v3-card">
    <div class="v3-card-heading">
        ...
        <a class="v3-button secondary" href="admin_v3.php?page=solicitudes">Ver todas</a>
    </div>
        ...
        <table class="v3-table">
            ...
            <?php foreach ($recent as $row): ?>
                ...
                <tr>
                    ...
                    <td><a class="v3-button secondary" href="admin_v3.php?page=expediente&id=<?= (int) $row['id'] ?>">Revisar</a></td>
                </tr>
            <?php endforeach; ?>
            </tbody>
        </table>
